...
ActiveRecord::Schema.define(version: 2021_12_07_183213) do
  ...
  create_table "places", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_record_id"], name: "index_places_on_purchase_record_id"
  end
  ...
  add_foreign_key "places", "purchase_records"
